            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    <p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">
                        Création avec Next.js
                    </p>
                    <TextGenerateEffect
                        className="text-center text-[40px] md:text-5xl lg:text-6xl"
                        words="Transformer les Concepts en Expériences Utilisateurs" />
                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                        Salut, je suis Emeric ! Entre Symfony et Next.js mon coeur balance.
                    </p>
                    <a href="#projets">
                        <MagicButton title="Voir les projets" icon={<FaLocationArrow />} position="right" />
                    </a>
                </div>
            </div>
        </div>
